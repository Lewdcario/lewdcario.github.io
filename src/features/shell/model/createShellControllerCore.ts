...
function buildShellController() {
	...
	const desktopActions = createDesktopActions({
		...
		openNetscapeBrowser: (...args: unknown[]) => browserMediaActions.openNetscapeBrowser(...args),
	...
	sessionActions = createSessionActions({
		...
		browserRenderMode,
		browserDocument,
		navigatorPlaceholderDocument: browserMediaActions.navigatorPlaceholderDocument,
		browserHistory,
		browserHistoryIndex,
		browserSearchMenuOpen,
		browserSearchQuery,
	...
	const { contextMenuTitle, contextMenuItems } = createShellContextMenuState({
		...
		openNetscapeBrowser: browserMediaActions.openNetscapeBrowser,
